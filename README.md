...
**Software engineer** — building **backend microservices** in production, now
also building **applied ML / computer vision for identity verification**
(liveness & deepfake detection). Ex-SSD firmware engineer.
